...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"PodList is a list of Pods.")]
    public partial class V1PodList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"List of pods. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md")]
