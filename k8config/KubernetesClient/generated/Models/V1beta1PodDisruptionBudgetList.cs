...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"PodDisruptionBudgetList is a collection of PodDisruptionBudgets.")]
    public partial class V1beta1PodDisruptionBudgetList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"items list individual PodDisruptionBudget objects")]
