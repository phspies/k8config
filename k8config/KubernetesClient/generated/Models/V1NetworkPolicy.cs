...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"NetworkPolicy describes what network traffic is allowed for a set of Pods")]
    public partial class V1NetworkPolicy
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Specification of the desired behavior for this NetworkPolicy.")]
