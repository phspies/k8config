...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"CustomResourceValidation is a list of validation methods for CustomResources.")]
    public partial class V1CustomResourceValidation
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"openAPIV3Schema is the OpenAPI v3 schema to use for validation and pruning.")]
