...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"SecretList is a list of Secret.")]
    public partial class V1SecretList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is a list of secret objects. More info: https://kubernetes.io/docs/concepts/configuration/secret")]
