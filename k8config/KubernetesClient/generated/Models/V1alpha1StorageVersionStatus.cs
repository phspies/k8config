...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"API server instances report the versions they can decode and the version they encode objects to when persisting objects in the backend.")]
    public partial class V1alpha1StorageVersionStatus
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"If all API server instances agree on the same encoding storage version, then this field is set to that version. Otherwise this field is left empty. API servers should finish updating its storageVersionStatus entry before serving write operations, so that this field will be in sync with the reality.")]
        public string CommonEncodingVersion { get; set; }

        [JsonProperty(PropertyName = "conditions")]
        [KubernetesProperty(IsRequired: false, Description: @"The latest available observations of the storageVersion&apos;s state.")]
        public IList<V1alpha1StorageVersionCondition> Conditions { get; set; }

        [JsonProperty(PropertyName = "storageVersions")]
        [KubernetesProperty(IsRequired: false, Description: @"The reported versions per API server instance.")]
