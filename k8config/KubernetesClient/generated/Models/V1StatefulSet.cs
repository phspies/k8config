...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"StatefulSet represents a set of pods with consistent identities. Identities are defined as: - Network: A single stable DNS and hostname. - Storage: As many VolumeClaims as requested.The StatefulSet guarantees that a given network identity will always map to the same storage identity.")]
    public partial class V1StatefulSet
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Spec defines the desired identities of pods in this set.")]
        public V1StatefulSetSpec Spec { get; set; }

        [JsonProperty(PropertyName = "status")]
        [KubernetesProperty(IsRequired: false, Description: @"Status is the current status of Pods in this StatefulSet. This data may be out of date by some window of time.")]
