...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ResourceQuotaList is a list of ResourceQuota items.")]
    public partial class V1ResourceQuotaList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is a list of ResourceQuota objects. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/")]
