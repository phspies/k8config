...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ClusterRoleBindingList is a collection of ClusterRoleBindings. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 ClusterRoleBindings, and will no longer be served in v1.22.")]
    public partial class V1alpha1ClusterRoleBindingList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is a list of ClusterRoleBindings")]
