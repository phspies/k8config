...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"NamespaceList is a list of Namespaces.")]
    public partial class V1NamespaceList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is the list of Namespace objects in the list. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/")]
