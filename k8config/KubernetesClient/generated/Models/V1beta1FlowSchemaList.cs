...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"FlowSchemaList is a list of FlowSchema objects.")]
    public partial class V1beta1FlowSchemaList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"`items` is a list of FlowSchemas.")]
        ...
        [KubernetesProperty(IsRequired: false, Description: @"`metadata` is the standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata")]
