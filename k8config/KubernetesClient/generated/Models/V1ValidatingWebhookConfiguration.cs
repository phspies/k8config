...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ValidatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and object without changing it.")]
