...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"PodSecurityPolicySpec defines the policy enforced.")]
    public partial class V1beta1PodSecurityPolicySpec
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"allowPrivilegeEscalation determines if a pod can request to allow privilege escalation. If unspecified, defaults to true.")]
        public bool? AllowPrivilegeEscalation { get; set; }

        [JsonProperty(PropertyName = "allowedCSIDrivers")]
        [KubernetesProperty(IsRequired: false, Description: @"AllowedCSIDrivers is an allowlist of inline CSI drivers that must be explicitly set to be embedded within a pod spec. An empty value indicates that any CSI driver can be used for inline ephemeral volumes. This is a beta field, and is only honored if the API server enables the CSIInlineVolume feature gate.")]
        public IList<V1beta1AllowedCSIDriver> AllowedCSIDrivers { get; set; }

        [JsonProperty(PropertyName = "allowedCapabilities")]
        [KubernetesProperty(IsRequired: false, Description: @"allowedCapabilities is a list of capabilities that can be requested to add to the container. Capabilities in this field may be added at the pod author&apos;s discretion. You must not list a capability in both allowedCapabilities and requiredDropCapabilities.")]
        public IList<string> AllowedCapabilities { get; set; }

        [JsonProperty(PropertyName = "allowedFlexVolumes")]
        [KubernetesProperty(IsRequired: false, Description: @"allowedFlexVolumes is an allowlist of Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the &quot;volumes&quot; field.")]
        public IList<V1beta1AllowedFlexVolume> AllowedFlexVolumes { get; set; }

        [JsonProperty(PropertyName = "allowedHostPaths")]
        [KubernetesProperty(IsRequired: false, Description: @"allowedHostPaths is an allowlist of host paths. Empty indicates that all host paths may be used.")]
        public IList<V1beta1AllowedHostPath> AllowedHostPaths { get; set; }

        [JsonProperty(PropertyName = "allowedProcMountTypes")]
        [KubernetesProperty(IsRequired: false, Description: @"AllowedProcMountTypes is an allowlist of allowed ProcMountTypes. Empty or nil indicates that only the DefaultProcMountType may be used. This requires the ProcMountType feature flag to be enabled.")]
        public IList<string> AllowedProcMountTypes { get; set; }

        [JsonProperty(PropertyName = "allowedUnsafeSysctls")]
        [KubernetesProperty(IsRequired: false, Description: @"allowedUnsafeSysctls is a list of explicitly allowed unsafe sysctls, defaults to none. Each entry is either a plain sysctl name or ends in &quot;*&quot; in which case it is considered as a prefix of allowed sysctls. Single * means all unsafe sysctls are allowed. Kubelet has to allowlist all allowed unsafe sysctls explicitly to avoid rejection.Examples: e.g. &quot;foo/*&quot; allows &quot;foo/bar&quot;, &quot;foo/baz&quot;, etc. e.g. &quot;foo.*&quot; allows &quot;foo.bar&quot;, &quot;foo.baz&quot;, etc.")]
        public IList<string> AllowedUnsafeSysctls { get; set; }

        [JsonProperty(PropertyName = "defaultAddCapabilities")]
        [KubernetesProperty(IsRequired: false, Description: @"defaultAddCapabilities is the default set of capabilities that will be added to the container unless the pod spec specifically drops the capability.  You may not list a capability in both defaultAddCapabilities and requiredDropCapabilities. Capabilities added here are implicitly allowed, and need not be included in the allowedCapabilities list.")]
        public IList<string> DefaultAddCapabilities { get; set; }

        [JsonProperty(PropertyName = "defaultAllowPrivilegeEscalation")]
        [KubernetesProperty(IsRequired: false, Description: @"defaultAllowPrivilegeEscalation controls the default setting for whether a process can gain more privileges than its parent process.")]
        public bool? DefaultAllowPrivilegeEscalation { get; set; }

        [JsonProperty(PropertyName = "forbiddenSysctls")]
        [KubernetesProperty(IsRequired: false, Description: @"forbiddenSysctls is a list of explicitly forbidden sysctls, defaults to none. Each entry is either a plain sysctl name or ends in &quot;*&quot; in which case it is considered as a prefix of forbidden sysctls. Single * means all sysctls are forbidden.Examples: e.g. &quot;foo/*&quot; forbids &quot;foo/bar&quot;, &quot;foo/baz&quot;, etc. e.g. &quot;foo.*&quot; forbids &quot;foo.bar&quot;, &quot;foo.baz&quot;, etc.")]
        public IList<string> ForbiddenSysctls { get; set; }

        [JsonProperty(PropertyName = "fsGroup")]
        [KubernetesProperty(IsRequired: true, Description: @"fsGroup is the strategy that will dictate what fs group is used by the SecurityContext.")]
        public V1beta1FSGroupStrategyOptions FsGroup { get; set; }

        [JsonProperty(PropertyName = "hostIPC")]
        [KubernetesProperty(IsRequired: false, Description: @"hostIPC determines if the policy allows the use of HostIPC in the pod spec.")]
        public bool? HostIPC { get; set; }

        [JsonProperty(PropertyName = "hostNetwork")]
        [KubernetesProperty(IsRequired: false, Description: @"hostNetwork determines if the policy allows the use of HostNetwork in the pod spec.")]
        public bool? HostNetwork { get; set; }

        [JsonProperty(PropertyName = "hostPID")]
        [KubernetesProperty(IsRequired: false, Description: @"hostPID determines if the policy allows the use of HostPID in the pod spec.")]
        public bool? HostPID { get; set; }

        [JsonProperty(PropertyName = "hostPorts")]
        [KubernetesProperty(IsRequired: false, Description: @"hostPorts determines which host port ranges are allowed to be exposed.")]
        public IList<V1beta1HostPortRange> HostPorts { get; set; }

        [JsonProperty(PropertyName = "privileged")]
        [KubernetesProperty(IsRequired: false, Description: @"privileged determines if a pod can request to be run as privileged.")]
        public bool? Privileged { get; set; }

        [JsonProperty(PropertyName = "readOnlyRootFilesystem")]
        [KubernetesProperty(IsRequired: false, Description: @"readOnlyRootFilesystem when set to true will force containers to run with a read only root file system.  If the container specifically requests to run with a non-read only root file system the PSP should deny the pod. If set to false the container may run with a read only root file system if it wishes but it will not be forced to.")]
        public bool? ReadOnlyRootFilesystem { get; set; }

        [JsonProperty(PropertyName = "requiredDropCapabilities")]
        [KubernetesProperty(IsRequired: false, Description: @"requiredDropCapabilities are the capabilities that will be dropped from the container.  These are required to be dropped and cannot be added.")]
        public IList<string> RequiredDropCapabilities { get; set; }

        [JsonProperty(PropertyName = "runAsGroup")]
        [KubernetesProperty(IsRequired: false, Description: @"RunAsGroup is the strategy that will dictate the allowable RunAsGroup values that may be set. If this field is omitted, the pod&apos;s RunAsGroup can take any value. This field requires the RunAsGroup feature gate to be enabled.")]
        public V1beta1RunAsGroupStrategyOptions RunAsGroup { get; set; }

        [JsonProperty(PropertyName = "runAsUser")]
        [KubernetesProperty(IsRequired: true, Description: @"runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.")]
        public V1beta1RunAsUserStrategyOptions RunAsUser { get; set; }

        [JsonProperty(PropertyName = "runtimeClass")]
        [KubernetesProperty(IsRequired: false, Description: @"runtimeClass is the strategy that will dictate the allowable RuntimeClasses for a pod. If this field is omitted, the pod&apos;s runtimeClassName field is unrestricted. Enforcement of this field depends on the RuntimeClass feature gate being enabled.")]
        public V1beta1RuntimeClassStrategyOptions RuntimeClass { get; set; }

        [JsonProperty(PropertyName = "seLinux")]
        [KubernetesProperty(IsRequired: true, Description: @"seLinux is the strategy that will dictate the allowable labels that may be set.")]
        public V1beta1SELinuxStrategyOptions SeLinux { get; set; }

        [JsonProperty(PropertyName = "supplementalGroups")]
        [KubernetesProperty(IsRequired: true, Description: @"supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.")]
        public V1beta1SupplementalGroupsStrategyOptions SupplementalGroups { get; set; }

        [JsonProperty(PropertyName = "volumes")]
        [KubernetesProperty(IsRequired: false, Description: @"volumes is an allowlist of volume plugins. Empty indicates that no volumes may be used. To allow all volumes you may use &apos;*&apos;.")]
