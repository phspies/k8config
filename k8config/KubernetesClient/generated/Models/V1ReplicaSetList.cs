...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ReplicaSetList is a collection of ReplicaSets.")]
    public partial class V1ReplicaSetList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller")]
