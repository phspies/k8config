...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"NodeList is the whole list of all Nodes which have been registered with master.")]
    public partial class V1NodeList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"List of nodes")]
