...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"StatefulSetList is a collection of StatefulSets.")]
    public partial class V1StatefulSetList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is the list of stateful sets.")]
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Standard list&apos;s metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata")]
