...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"APIResourceList is a list of APIResource, it is used to expose the name of the resources supported in a specific group and version, and if the resource is namespaced.")]
    public partial class V1APIResourceList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"groupVersion is the group and version this APIResourceList is for.")]
        ...
        [KubernetesProperty(IsRequired: true, Description: @"resources contains the name of the resources and if they are namespaced.")]
