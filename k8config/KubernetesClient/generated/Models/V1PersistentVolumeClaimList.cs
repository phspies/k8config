...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"PersistentVolumeClaimList is a list of PersistentVolumeClaim items.")]
    public partial class V1PersistentVolumeClaimList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"A list of persistent volume claims. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims")]
