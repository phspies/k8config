...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"TokenReview attempts to authenticate a token to a known user. Note: TokenReview requests may be cached by the webhook token authenticator plugin in the kube-apiserver.")]
    public partial class V1TokenReview
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Status is filled in by the server and indicates whether the request can be authenticated.")]
