...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"A node selector represents the union of the results of one or more label queries over a set of nodes; that is, it represents the OR of the selectors represented by the node selector terms.")]
    public partial class V1NodeSelector
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Required. A list of node selector terms. The terms are ORed.")]
