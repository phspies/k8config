...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"list of horizontal pod autoscaler objects.")]
    public partial class V1HorizontalPodAutoscalerList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"list of horizontal pod autoscaler objects.")]
