...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ServiceAccountList is a list of ServiceAccount objects")]
    public partial class V1ServiceAccountList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"List of ServiceAccounts. More info: https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/")]
