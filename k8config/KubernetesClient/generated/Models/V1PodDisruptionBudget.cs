...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"PodDisruptionBudget is an object to define the max disruption that can be caused to a collection of pods")]
    public partial class V1PodDisruptionBudget
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Specification of the desired behavior of the PodDisruptionBudget.")]
        public V1PodDisruptionBudgetSpec Spec { get; set; }

        [JsonProperty(PropertyName = "status")]
        [KubernetesProperty(IsRequired: false, Description: @"Most recently observed status of the PodDisruptionBudget.")]
