...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ClusterRole is a cluster level, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding or ClusterRoleBinding. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 ClusterRole, and will no longer be served in v1.22.")]
    public partial class V1alpha1ClusterRole
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller.")]
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Rules holds all the PolicyRules for this ClusterRole")]
