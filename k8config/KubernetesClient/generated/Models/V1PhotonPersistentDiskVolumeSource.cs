...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"Represents a Photon Controller persistent disk resource.")]
    public partial class V1PhotonPersistentDiskVolumeSource
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"ID that identifies Photon Controller persistent disk")]
