...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"LimitRange sets resource usage limits for each kind of resource in a Namespace.")]
    public partial class V1LimitRange
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Spec defines the limits enforced. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status")]
