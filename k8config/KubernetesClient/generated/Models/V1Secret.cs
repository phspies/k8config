...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"Secret holds secret data of a certain type. The total bytes of the values in the Data field must be less than MaxSecretSize bytes.")]
    public partial class V1Secret
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Data contains the secret data. Each key must consist of alphanumeric characters, &apos;-&apos;, &apos;_&apos; or &apos;.&apos;. The serialized form of the secret data is a base64 encoded string, representing the arbitrary (possibly non-string) data value here. Described in https://tools.ietf.org/html/rfc4648#section-4")]
        public IDictionary<string, byte[]> Data { get; set; }

        [JsonProperty(PropertyName = "immutable")]
        [KubernetesProperty(IsRequired: false, Description: @"Immutable, if set to true, ensures that data stored in the Secret cannot be updated (only object metadata can be modified). If not set to true, the field can be modified at any time. Defaulted to nil.")]
        ...
        [KubernetesProperty(IsRequired: false, Description: @"stringData allows specifying non-binary secret data in string form. It is provided as a write-only input field for convenience. All keys and values are merged into the data field on write, overwriting any existing values. The stringData field is never output when reading from the API.")]
        public IDictionary<string, string> StringData { get; set; }

        [JsonProperty(PropertyName = "type")]
        [KubernetesProperty(IsRequired: false, Description: @"Used to facilitate programmatic handling of secret data.")]
