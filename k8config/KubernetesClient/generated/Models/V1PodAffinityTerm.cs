...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"Defines a set of pods (namely those matching the labelSelector relative to the given namespace(s)) that this pod should be co-located (affinity) or not co-located (anti-affinity) with, where co-located is defined as running on a node whose value of the label with key &lt;topologyKey&gt; matches that of any node on which a pod of the set of pods is running")]
    public partial class V1PodAffinityTerm
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"A label query over a set of resources, in this case pods.")]
        public V1LabelSelector LabelSelector { get; set; }

        [JsonProperty(PropertyName = "namespaceSelector")]
        [KubernetesProperty(IsRequired: false, Description: @"A label query over the set of namespaces that the term applies to. The term is applied to the union of the namespaces selected by this field and the ones listed in the namespaces field. null selector and null or empty namespaces list means &quot;this pod&apos;s namespace&quot;. An empty selector ({}) matches all namespaces. This field is beta-level and is only honored when PodAffinityNamespaceSelector feature is enabled.")]
        ...
        [KubernetesProperty(IsRequired: true, Description: @"This pod should be co-located (affinity) or not co-located (anti-affinity) with the pods matching the labelSelector in the specified namespaces, where co-located is defined as running on a node whose value of the label with key topologyKey matches that of any node on which any of the selected pods is running. Empty topologyKey is not allowed.")]
