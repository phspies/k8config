...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"RoleList is a collection of Roles. Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 RoleList, and will no longer be served in v1.22.")]
    public partial class V1alpha1RoleList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is a list of Roles")]
