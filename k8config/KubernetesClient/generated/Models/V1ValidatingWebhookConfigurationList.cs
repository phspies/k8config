...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ValidatingWebhookConfigurationList is a list of ValidatingWebhookConfiguration.")]
    public partial class V1ValidatingWebhookConfigurationList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"List of ValidatingWebhookConfiguration.")]
