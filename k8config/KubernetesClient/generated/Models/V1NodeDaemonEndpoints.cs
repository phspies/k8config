...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"NodeDaemonEndpoints lists ports opened by daemons running on the Node.")]
    public partial class V1NodeDaemonEndpoints
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Endpoint on which Kubelet is listening.")]
