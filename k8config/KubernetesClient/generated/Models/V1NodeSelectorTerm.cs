...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"A null or empty node selector term matches no objects. The requirements of them are ANDed. The TopologySelectorTerm type implements a subset of the NodeSelectorTerm.")]
    public partial class V1NodeSelectorTerm
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"A list of node selector requirements by node&apos;s labels.")]
        public IList<V1NodeSelectorRequirement> MatchExpressions { get; set; }

        [JsonProperty(PropertyName = "matchFields")]
        [KubernetesProperty(IsRequired: false, Description: @"A list of node selector requirements by node&apos;s fields.")]
