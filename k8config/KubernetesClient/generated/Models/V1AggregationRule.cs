...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"AggregationRule describes how to locate ClusterRoles to aggregate into the ClusterRole")]
    public partial class V1AggregationRule
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"ClusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole&apos;s permissions will be added")]
