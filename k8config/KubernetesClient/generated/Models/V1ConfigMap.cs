...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ConfigMap holds configuration data for pods to consume.")]
    public partial class V1ConfigMap
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"BinaryData contains the binary data. Each key must consist of alphanumeric characters, &apos;-&apos;, &apos;_&apos; or &apos;.&apos;. BinaryData can contain byte sequences that are not in the UTF-8 range. The keys stored in BinaryData must not overlap with the ones in the Data field, this is enforced during validation process. Using this field will require 1.10+ apiserver and kubelet.")]
        public IDictionary<string, byte[]> BinaryData { get; set; }

        [JsonProperty(PropertyName = "data")]
        [KubernetesProperty(IsRequired: false, Description: @"Data contains the configuration data. Each key must consist of alphanumeric characters, &apos;-&apos;, &apos;_&apos; or &apos;.&apos;. Values with non-UTF-8 byte sequences must use the BinaryData field. The keys stored in Data must not overlap with the keys in the BinaryData field, this is enforced during validation process.")]
        public IDictionary<string, string> Data { get; set; }

        [JsonProperty(PropertyName = "immutable")]
        [KubernetesProperty(IsRequired: false, Description: @"Immutable, if set to true, ensures that data stored in the ConfigMap cannot be updated (only object metadata can be modified). If not set to true, the field can be modified at any time. Defaulted to nil.")]
