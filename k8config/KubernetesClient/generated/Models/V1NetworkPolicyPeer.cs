...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"NetworkPolicyPeer describes a peer to allow traffic to/from. Only certain combinations of fields are allowed")]
    public partial class V1NetworkPolicyPeer
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"IPBlock defines policy on a particular IPBlock. If this field is set then neither of the other fields can be.")]
        public V1IPBlock IpBlock { get; set; }

        [JsonProperty(PropertyName = "namespaceSelector")]
        [KubernetesProperty(IsRequired: false, Description: @"Selects Namespaces using cluster-scoped labels. This field follows standard label selector semantics; if present but empty, it selects all namespaces.If PodSelector is also set, then the NetworkPolicyPeer as a whole selects the Pods matching PodSelector in the Namespaces selected by NamespaceSelector. Otherwise it selects all Pods in the Namespaces selected by NamespaceSelector.")]
        public V1LabelSelector NamespaceSelector { get; set; }

        [JsonProperty(PropertyName = "podSelector")]
        [KubernetesProperty(IsRequired: false, Description: @"This is a label selector which selects Pods. This field follows standard label selector semantics; if present but empty, it selects all pods.If NamespaceSelector is also set, then the NetworkPolicyPeer as a whole selects the Pods matching PodSelector in the Namespaces selected by NamespaceSelector. Otherwise it selects the Pods matching PodSelector in the policy&apos;s own Namespace.")]
