...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"PersistentVolumeList is a list of PersistentVolume items.")]
    public partial class V1PersistentVolumeList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"List of persistent volumes. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes")]
