...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"RoleBindingList is a collection of RoleBindings Deprecated in v1.17 in favor of rbac.authorization.k8s.io/v1 RoleBindingList, and will no longer be served in v1.22.")]
    public partial class V1alpha1RoleBindingList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is a list of RoleBindings")]
