...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"PersistentVolumeClaim is a user&apos;s request for and claim to a persistent volume")]
    public partial class V1PersistentVolumeClaim
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Spec defines the desired characteristics of a volume requested by a pod author. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims")]
        public V1PersistentVolumeClaimSpec Spec { get; set; }

        [JsonProperty(PropertyName = "status")]
        [KubernetesProperty(IsRequired: false, Description: @"Status represents the current information/status of a persistent volume claim. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims")]
