...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ConfigMapList is a resource containing a list of ConfigMap objects.")]
    public partial class V1ConfigMapList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is the list of ConfigMaps.")]
