...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"SelfSubjectAccessReview checks whether or the current user can perform an action.  Not filling in a spec.namespace means &quot;in all namespaces&quot;.  Self is a special case, because users should always be able to check whether they can perform an action")]
    public partial class V1SelfSubjectAccessReview
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Spec holds information about the request being evaluated.  user and groups must be empty")]
