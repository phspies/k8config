...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"VolumeAttachmentList is a collection of VolumeAttachment objects.")]
    public partial class V1VolumeAttachmentList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is the list of VolumeAttachments")]
