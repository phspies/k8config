...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"configuration of a horizontal pod autoscaler.")]
    public partial class V1HorizontalPodAutoscaler
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"behaviour of autoscaler. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.")]
        public V1HorizontalPodAutoscalerSpec Spec { get; set; }

        [JsonProperty(PropertyName = "status")]
        [KubernetesProperty(IsRequired: false, Description: @"current information about the autoscaler.")]
