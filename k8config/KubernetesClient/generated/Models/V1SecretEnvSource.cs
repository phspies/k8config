...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"SecretEnvSource selects a Secret to populate the environment variables with.The contents of the target Secret&apos;s Data field will represent the key-value pairs as environment variables.")]
    public partial class V1SecretEnvSource
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Specify whether the Secret must be defined")]
