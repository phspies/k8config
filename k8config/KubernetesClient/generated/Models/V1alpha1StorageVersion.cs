...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @" Storage version of a specific resource.")]
    public partial class V1alpha1StorageVersion
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"The name is &lt;group&gt;.&lt;resource&gt;.")]
        public V1ObjectMeta Metadata { get; set; }

        [JsonProperty(PropertyName = "spec")]
        [KubernetesProperty(IsRequired: true, Description: @"Spec is an empty spec. It is here to comply with Kubernetes API style.")]
        public object Spec { get; set; }

        [JsonProperty(PropertyName = "status")]
        [KubernetesProperty(IsRequired: true, Description: @"API server instances report the version they can decode and the version they encode objects to when persisting objects in the backend.")]
