...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"FlexPersistentVolumeSource represents a generic persistent volume resource that is provisioned/attached using an exec based plugin.")]
    public partial class V1FlexPersistentVolumeSource
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Driver is the name of the driver to use for this volume.")]
        public string Driver { get; set; }

        [JsonProperty(PropertyName = "fsType")]
        [KubernetesProperty(IsRequired: false, Description: @"Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. &quot;ext4&quot;, &quot;xfs&quot;, &quot;ntfs&quot;. The default filesystem depends on FlexVolume script.")]
        public string FsType { get; set; }

        [JsonProperty(PropertyName = "options")]
        [KubernetesProperty(IsRequired: false, Description: @"Optional: Extra command options if any.")]
