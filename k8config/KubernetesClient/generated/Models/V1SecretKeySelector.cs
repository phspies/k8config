...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"SecretKeySelector selects a key of a Secret.")]
    public partial class V1SecretKeySelector
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"The key of the secret to select from.  Must be a valid secret key.")]
