...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"LimitRangeList is a list of LimitRange items.")]
    public partial class V1LimitRangeList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is a list of LimitRange objects. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/")]
