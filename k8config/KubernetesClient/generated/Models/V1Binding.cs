...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"Binding ties one object to another; for example, a pod is bound to a node by a scheduler. Deprecated in 1.7, please use the bindings subresource of pods instead.")]
    public partial class V1Binding
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"The target object that you want to bind to the standard object.")]
