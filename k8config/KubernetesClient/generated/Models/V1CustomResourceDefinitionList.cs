...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"CustomResourceDefinitionList is a list of CustomResourceDefinition objects.")]
    public partial class V1CustomResourceDefinitionList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"items list individual CustomResourceDefinition objects")]
