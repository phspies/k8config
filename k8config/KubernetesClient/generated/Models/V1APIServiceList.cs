...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"APIServiceList is a list of APIService objects.")]
    public partial class V1APIServiceList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is the list of APIService")]
