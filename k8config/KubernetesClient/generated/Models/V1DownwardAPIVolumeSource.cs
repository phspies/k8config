...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"DownwardAPIVolumeSource represents a volume containing downward API info. Downward API volumes support ownership management and SELinux relabeling.")]
    public partial class V1DownwardAPIVolumeSource
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Items is a list of downward API volume file")]
