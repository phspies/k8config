...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"PriorityLevelConfiguration represents the configuration of a priority level.")]
    public partial class V1beta1PriorityLevelConfiguration
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"`spec` is the specification of the desired behavior of a &quot;request-priority&quot;. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status")]
        public V1beta1PriorityLevelConfigurationSpec Spec { get; set; }

        [JsonProperty(PropertyName = "status")]
        [KubernetesProperty(IsRequired: false, Description: @"`status` is the current status of a &quot;request-priority&quot;. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status")]
