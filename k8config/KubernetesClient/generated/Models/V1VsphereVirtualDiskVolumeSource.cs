...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"Represents a vSphere volume resource.")]
    public partial class V1VsphereVirtualDiskVolumeSource
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Storage Policy Based Management (SPBM) profile ID associated with the StoragePolicyName.")]
        public string StoragePolicyID { get; set; }

        [JsonProperty(PropertyName = "storagePolicyName")]
        [KubernetesProperty(IsRequired: false, Description: @"Storage Policy Based Management (SPBM) profile name.")]
        public string StoragePolicyName { get; set; }

        [JsonProperty(PropertyName = "volumePath")]
        [KubernetesProperty(IsRequired: true, Description: @"Path that identifies vSphere volume vmdk")]
