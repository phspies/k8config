...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ClusterRole is a cluster level, logical grouping of PolicyRules that can be referenced as a unit by a RoleBinding or ClusterRoleBinding.")]
