...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"PodSecurityPolicy governs the ability to make requests that affect the Security Context that will be applied to a pod and container. Deprecated in 1.21.")]
    public partial class V1beta1PodSecurityPolicy
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"spec defines the policy enforced.")]
