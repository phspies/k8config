...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"CustomResourceDefinition represents a resource that should be exposed on the API server.  Its name MUST be in the format &lt;.spec.name&gt;.&lt;.spec.group&gt;.")]
    public partial class V1CustomResourceDefinition
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"spec describes how the user wants the resources to appear")]
        public V1CustomResourceDefinitionSpec Spec { get; set; }

        [JsonProperty(PropertyName = "status")]
        [KubernetesProperty(IsRequired: false, Description: @"status indicates the actual state of the CustomResourceDefinition")]
