...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"IngressSpec describes the Ingress the user wishes to exist.")]
    public partial class V1IngressSpec
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"DefaultBackend is the backend that should handle requests that don&apos;t match any rule. If Rules are not specified, DefaultBackend must be specified. If DefaultBackend is not set, the handling of requests that do not match any of the rules will be up to the Ingress controller.")]
        public V1IngressBackend DefaultBackend { get; set; }

        [JsonProperty(PropertyName = "ingressClassName")]
        [KubernetesProperty(IsRequired: false, Description: @"IngressClassName is the name of the IngressClass cluster resource. The associated IngressClass defines which controller will implement the resource. This replaces the deprecated `kubernetes.io/ingress.class` annotation. For backwards compatibility, when that annotation is set, it must be given precedence over this field. The controller may emit a warning if the field and annotation have different values. Implementations of this API should ignore Ingresses without a class specified. An IngressClass resource may be marked as default, which can be used to set a default value for this field. For more information, refer to the IngressClass documentation.")]
        public string IngressClassName { get; set; }

        [JsonProperty(PropertyName = "rules")]
        [KubernetesProperty(IsRequired: false, Description: @"A list of host rules used to configure the Ingress. If unspecified, or no rule matches, all traffic is sent to the default backend.")]
        public IList<V1IngressRule> Rules { get; set; }

        [JsonProperty(PropertyName = "tls")]
        [KubernetesProperty(IsRequired: false, Description: @"TLS configuration. Currently the Ingress only supports a single TLS port, 443. If multiple members of this list specify different hosts, they will be multiplexed on the same port according to the hostname specified through the SNI TLS extension, if the ingress controller fulfilling the ingress supports SNI.")]
