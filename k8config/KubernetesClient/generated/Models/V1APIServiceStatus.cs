...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"APIServiceStatus contains derived information about an API server")]
    public partial class V1APIServiceStatus
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Current service state of apiService.")]
