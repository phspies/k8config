...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ContainerState holds a possible state of container. Only one of its members may be specified. If none of them is specified, the default one is ContainerStateWaiting.")]
    public partial class V1ContainerState
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Details about a running container")]
        public V1ContainerStateRunning Running { get; set; }

        [JsonProperty(PropertyName = "terminated")]
        [KubernetesProperty(IsRequired: false, Description: @"Details about a terminated container")]
        public V1ContainerStateTerminated Terminated { get; set; }

        [JsonProperty(PropertyName = "waiting")]
        [KubernetesProperty(IsRequired: false, Description: @"Details about a waiting container")]
