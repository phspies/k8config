...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"Job represents the configuration of a single job.")]
    public partial class V1Job
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Specification of the desired behavior of a job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status")]
        public V1JobSpec Spec { get; set; }

        [JsonProperty(PropertyName = "status")]
        [KubernetesProperty(IsRequired: false, Description: @"Current status of a job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status")]
