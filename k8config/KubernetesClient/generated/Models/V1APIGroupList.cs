...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"APIGroupList is a list of APIGroup, to allow clients to discover the API at /apis.")]
    public partial class V1APIGroupList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"groups is a list of APIGroup.")]
