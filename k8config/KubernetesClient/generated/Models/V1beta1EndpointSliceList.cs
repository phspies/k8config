...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"EndpointSliceList represents a list of endpoint slices")]
    public partial class V1beta1EndpointSliceList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"List of endpoint slices")]
