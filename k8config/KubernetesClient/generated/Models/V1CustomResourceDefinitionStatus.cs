...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"CustomResourceDefinitionStatus indicates the state of the CustomResourceDefinition")]
    public partial class V1CustomResourceDefinitionStatus
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"acceptedNames are the names that are actually being used to serve discovery. They may be different than the names in spec.")]
        public V1CustomResourceDefinitionNames AcceptedNames { get; set; }

        [JsonProperty(PropertyName = "conditions")]
        [KubernetesProperty(IsRequired: false, Description: @"conditions indicate state for particular aspects of a CustomResourceDefinition")]
        public IList<V1CustomResourceDefinitionCondition> Conditions { get; set; }

        [JsonProperty(PropertyName = "storedVersions")]
        [KubernetesProperty(IsRequired: false, Description: @"storedVersions lists all versions of CustomResources that were ever persisted. Tracking these versions allows a migration path for stored versions in etcd. The field is mutable so a migration controller can finish a migration to another version (ensuring no old objects are left in storage), and then remove the rest of the versions from this list. Versions may not be removed from `spec.versions` while they exist in this list.")]
