...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"UncountedTerminatedPods holds UIDs of Pods that have terminated but haven&apos;t been accounted in Job status counters.")]
    public partial class V1UncountedTerminatedPods
    {
        ...
        [KubernetesProperty(IsRequired: false, Description: @"Failed holds UIDs of failed Pods.")]
        public IList<string> Failed { get; set; }

        [JsonProperty(PropertyName = "succeeded")]
        [KubernetesProperty(IsRequired: false, Description: @"Succeeded holds UIDs of succeeded Pods.")]
