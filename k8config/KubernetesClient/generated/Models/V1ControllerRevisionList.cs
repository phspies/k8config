...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"ControllerRevisionList is a resource containing a list of ControllerRevision objects.")]
    public partial class V1ControllerRevisionList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"Items is the list of ControllerRevisions")]
