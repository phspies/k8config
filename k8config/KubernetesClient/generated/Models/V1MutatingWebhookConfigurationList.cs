...
namespace k8s.Models
{
    ...
    /// </summary>
    [KubernetesProperty(Description: @"MutatingWebhookConfigurationList is a list of MutatingWebhookConfiguration.")]
    public partial class V1MutatingWebhookConfigurationList
    {
        ...
        [KubernetesProperty(IsRequired: true, Description: @"List of MutatingWebhookConfiguration.")]
